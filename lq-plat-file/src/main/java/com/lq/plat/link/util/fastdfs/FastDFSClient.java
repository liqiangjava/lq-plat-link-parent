package com.lq.plat.link.util.fastdfs;
...
public class FastDFSClient {
	...
	private static final String CONF_FILENAME = Thread.currentThread().getContextClassLoader().getResource("").getPath() + "conf/conf-fdfs.properties";
