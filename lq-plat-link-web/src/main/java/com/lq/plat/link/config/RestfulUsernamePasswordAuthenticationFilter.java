...
public class RestfulUsernamePasswordAuthenticationFilter extends
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        if(StringUtils.isEmpty(username) && StringUtils.isEmpty(password)) {
            Map result = new ObjectMapper().readValue(request.getReader(), Map.class);
             username = String.valueOf(result.get(usernameParameter));
             password = String.valueOf(result.get(passwordParameter));
        }
        if (username == null) {
            username = "";
        }
