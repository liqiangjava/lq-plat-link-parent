 ...
 * 
 */
package com.lq.plat.link.repository.spec.support;
 ...
 *
 */
public abstract class PlatformSimpleSpecification<T, C> extends AbstractEventConditionBuilder<T, C>
	 ...
	 * @param condition
	 */
	public PlatformSimpleSpecification(C condition) {
		super(condition);
	}
